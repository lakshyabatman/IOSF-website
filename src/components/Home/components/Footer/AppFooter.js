        ...
        <Container>
          <Content>
            <blockquote>
              ...
              <Button className="footer__joinUsBtn" size="medium" renderAs="a" href="https://toolsiosf.typeform.com/to/KMqzcJHK">JOIN US <i className="fas fa-arrow-right"></i></Button>
            </blockquote>
            <Columns>
